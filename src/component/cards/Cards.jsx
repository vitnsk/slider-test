      ...
      <div className={`${styles.cardForm} ${styles.cardFormMedia}`}>
        ...
        <div className={styles.cardHead}>
          <div className={styles.clientBlock}>
            <div className={`${styles.topIcon} ${styles.goodsIcon}`}></div>
            <div className={`${styles.warrantyIcon} ${styles.goodsIcon}`}></div>
            <div className={`${styles.discountIcon} ${styles.goodsIcon}`}></div>
            <div className={`${styles.presentIcon} ${styles.goodsIcon}`}></div>
            <div className={`${styles.hitIcon} ${styles.goodsIcon}`}></div>
          </div>
        ...
        <div className={styles.textForm}>
          <div className={styles.productDescription}>
            <div
              className={`${styles.productSpecifications} ${styles.productSpecificationsMedia}`}
            >
              <span>{item.specifications}</span>
            </div>
            <div
              className={`${styles.productRating} ${styles.productRatingMedia}`}
            >
          ...
          <div className={styles.productCart}>
            <div
              className={`${styles.productQuantityBlock} ${styles.productQuantityBlockMedia}`}
            >
              <button
              ...
              ></button>
              <input
                className={styles.quantityProduct}
                value={counter}
            ...
            <div className={styles.cartButtonBlock}>
              <button
                className={`${styles.cartButton} ${styles.cartButtonMedia}`}
              >
                В корзину
              </button>
            </div>
            <div className={styles.likeButtonBlock}>
              <button
                className={`${styles.likeButton} ${styles.likeButtonMedia}`}
              ></button>
            </div>
          </div>
          ...
          <div className={styles.oneClickBlock}>
            <button
              className={`${styles.oneClickButton} ${styles.oneClickButtonMedia}`}
            >
              Купить в 1 клик
            </button>
          </div>
